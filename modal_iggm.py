...
image = (
    ...
    # NB: uv_pip_install resolves openmm to a wheel requiring CXXABI_1.3.15
    # (not in debian's libstdc++) and lets numpy upgrade past the 1.23.5 pin.
    # Sticking with pip_install here.
    .pip_install(
        "torch==2.1.2+cu121",
